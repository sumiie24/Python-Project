...
Label(root,text="||   Fast n Furious 9  ||",font="Georgia 30 bold",bg="Purple",fg="MistyRose",width=50,bd=20).grid(row=0,column=0,columnspan=5)
Label(root,text="Select your Seats , Price and Show Time for Fast n Furious movie?",font="cambria 20 bold",bg="lightblue").grid(row=1,column=0,pady=30,padx=0)
