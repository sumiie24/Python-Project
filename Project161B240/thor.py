...
#===============Labels and Buttons================================
Label(root,text=" ||   Thor: Ragnarok   ||",font="Georgia 30 bold",bg="Purple",fg="MistyRose",width=50,bd=20).grid(row=0,column=0,columnspan=5)
Label(root,text="Select your Seats , Price and Show Time for Thor movie?",font="cambria 20 bold",bg="lightblue").grid(row=1,column=0,pady=30,padx=0)
...
Button(root,text="Check Rs.",font="times 20 bold",relief=SUNKEN,bg="black",fg="white",command=check,bd=10).grid(row=13,column=1,sticky=W)
